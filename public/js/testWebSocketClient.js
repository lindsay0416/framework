...
var options = {
  headers: {
    "cid": "course1",
    "uuid": "course1",
    "configure": "en-US_BroadbandModel"
  }
};


var connection = new WebSocket(host);
// var connection = new WebSocket('ws://cacs.mybluemix.net');
// console.log(host);
...
function onopen(e) {
  ...
  function success(e) {
    ...
    recorder.onaudioprocess = function (e) {
      ...
      var resampled = downsampleBuffer(left, 44100);
...
function onmessage(e) {
  console.log(e.data)
  $('#transcription').html(e.data.replace('&&', ''));




  if (e.data.includes("&&")) {
    $('#transcript').append(`<p>${e.data.substring(2)}</p>`);
